-- fpga_hashjoin UDP smoke test.
--
-- Prerequisites on Windows:
--   - board programmed with the RMII UDP stream bridge bitstream;
--   - host NIC has 169.254.242.59/16;
--   - static ARP maps 169.254.242.60 to 02-00-00-00-00-01.

LOAD 'fpga_hashjoin';
SET fpga.enabled = on;
SET fpga.simulation = off;
SET fpga.transport = 'udp';
SET fpga.device = :fpga_host;
